  ...
  while (playagain == true)
    {
              ...
              if (choice == 'h' && numPcards <= 9) //chooses to hit
                 ...
                 if (split == 0)
                  ...
                  if (getBestScore(phand, numPcards) > 21)
                  ...
                  else if (split == 1)
                    {
                      ...
                      if (getBestScore(phand, numPcards) > 21)
                        {
                          cout << "Hand 1 Busts with " << getBestScore(phand, numPcards) << endl;
                          split = 2;
                        }
                    }
                  else
                      ...
                      if (getBestScore(phand2, numP2cards) > 21)
                        {
                          split = 3;
                          buststay = true;
                          cout << "Hand 2 Busts with " << getBestScore(phand2, numP2cards) << endl;
                        }
                    }
                }
              ...
              else if (choice == 'd') //choose to double down
                {
                  ...
                  //busts, leave the loop
                    ...
                    {
                      cout << "Hand 2 Busts with " << getBestScore(phand, numPcards) << endl;
                      buststay = true;
                      split = 3;
                    }
                  else
      ...
      if (offrip21 == false && surrender == false)
      {
